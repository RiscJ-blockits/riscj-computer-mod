...
class ExecutorTest {
    ...
    void setUp() {
        ...
        ((RegisterModel) registerController1.getModel()).setWordLength(4);
        ((RegisterModel) registerController2.getModel()).setWordLength(4);
        ((RegisterModel) registerController3.getModel()).setWordLength(4);
        ((RegisterModel) registerController4.getModel()).setWordLength(4);
        ((RegisterModel) registerController5.getModel()).setWordLength(4);
