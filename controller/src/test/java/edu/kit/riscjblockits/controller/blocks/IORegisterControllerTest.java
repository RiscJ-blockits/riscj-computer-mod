...
class IORegisterControllerTest {
    ...
    @Test
    void getValue() {
        IORegisterController controller = new IORegisterController(new ArchiCheckStub_Entity(), true, REDSTONE_INPUT );
    ...
    @Test
    void setNewValue() {
        IORegisterController controller = new IORegisterController(new ArchiCheckStub_Entity(), false, REDSTONE_INPUT );
        assertEquals(new Value(), controller.getValue());
    }
