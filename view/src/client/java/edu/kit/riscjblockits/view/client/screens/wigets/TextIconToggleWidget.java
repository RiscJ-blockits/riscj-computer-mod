...
public class TextIconToggleWidget extends ButtonWidget {
    ...
    ButtonTextures textures = new ButtonTextures(TEXTURE_UNSELECTED, TEXTURE_SELECTED);
    ...
    public void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawGuiTexture(this.textures.get(this.selected, this.isSelected()), this.getX(), this.getY(), this.width, this.height);
